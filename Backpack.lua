...
weldhorn.Part1=r65.Head
weldhorn.C0=CFrame.new(0.3,-1.1,0)

horn1t=Instance.new("Part",r65)
horn1t.FormFactor = "Custom"
horn1t.CanCollide = false
horn1t.Size = Vector3.new(0.5,0.5,1.5)
hornmesh1=Instance.new("CylinderMesh",horn1t)

wefh=Instance.new("Weld",horn1t)
wefh.Part0=horn1t
wefh.Part1=horn1
wefh.C0=CFrame.new(0,-0.5,0)
wefh.C1 = CFrame.fromEulerAnglesXYZ(0,1.5,0.1)
fh=Instance.new("Fire",horn1t)
fh.Size = 0.1

horn2=Instance.new("Part",r65)
...
weldhorn2.Part1=r65.Head
weldhorn2.C0=CFrame.new(-0.3,-1.1,0)

horn2t=Instance.new("Part",r65)
horn2t.FormFactor = "Custom"
horn2t.CanCollide = false
horn2t.Size = Vector3.new(0.5,0,1.5)
...
weffh.C1 = CFrame.fromEulerAnglesXYZ(0,1.5,1.0)
